...
def house(x, y, height, width):
    house_main = polygon(screen, brown_light, [(x, y), (x+width, y), (x+width, y-height), (x, y-height)], 0)
    house_border = polygon(screen, (0,0,0), [(x, y), (x+width, y), (x+width, y-height), (x, y-height)], 1)
    house_hat = polygon(screen, pink_dark, [(x, y-height),(x+width, y-height),(x+width/2, y - 3*height/2)])
    house_hat_border = polygon(screen, (0,0,0), [(x, y-height),(x+width, y-height),(x+width/2, y - 3*height/2)], 1)
    window = polygon(screen, blue_dark, [(x+3*width/8, y-3*height/9),(x+5*width/8, y-3*height/9),(x+5*width/8, y-6*height/9),(x+3*width/8, y-6*height/9)], 0)
    window_border = polygon(screen, pink_dark, [(x+3*width/8, y-3*height/9),(x+5*width/8, y-3*height/9),(x+5*width/8, y-6*height/9),(x+3*width/8, y-6*height/9)], 1)
...
def tree(x,y, scale):
    tree_bottom = polygon(screen, brown_dark, [(x, y),(x+scale*20,y),(x+scale*20, y-scale*100),(x, y-scale*100)])
    d = 0
    h = 0
    c = 0
...
a2 = 22.5
def sun(x,y,color):
    polygon(screen, color, [(x, y - R1), (x + R2 * np.cos(k * a1), y - R2 * np.sin(k * a1)),
                            (x + R1 * np.cos(k * 45), y - R1 * np.sin(k * 45)),
                            (x + R2 * np.cos(k * a2), y - R2 * np.sin(k * a2)), (x + R1, y),
                            (x + R2 * np.cos(k * a2), y + R2 * np.sin(k * a2)),
                            (x + R1 * np.cos(k * 45), y + R1 * np.sin(k * 45)),
                            (x + R2 * np.cos(k * a1), y + R2 * np.sin(k * a1)), (x, y + R1),
    ...
    polygon(screen, black, [(x, y - R1), (x + R2 * np.cos(k * a1), y - R2 * np.sin(k * a1)),
                            (x + R1 * np.cos(k * 45), y - R1 * np.sin(k * 45)),
                            (x + R2 * np.cos(k * a2), y - R2 * np.sin(k * a2)), (x + R1, y),
                            (x + R2 * np.cos(k * a2), y + R2 * np.sin(k * a2)),
                            (x + R1 * np.cos(k * 45), y + R1 * np.sin(k * 45)),
                            ...
                            (x - R2 * np.cos(k * a2), y - R2 * np.sin(k * a2)),
                            (x - np.cos(k * 45) * R1, y - np.sin(k * 45) * R1),
                            (x - R2 * np.cos(k * a1), y - R2 * np.sin(k * a1))],1)
